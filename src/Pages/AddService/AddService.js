...
const AddService = () => {
    ...
    return (
        <div>
            <h3 className='text-center mt-4'>Please Add a Service</h3>
            <form className='w-50 mx-auto my-5 d-flex flex-column' onSubmit={handleSubmit( onSubmit )}>
                <input placeholder='Name' className='mb-2' type="text" {...register( "name", { required: true, maxLength: 20 } )} />
